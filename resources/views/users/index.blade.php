...
<div class="modal-wrapper" id="popup2">
  <div style="background: transparent;" class="popup2-contenedor">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card">
          <div class="card-header">{{ __('Register') }}<a style="background:transparent; color: black; position: absolute; right:25px;" href="{{ route('users.index',$user) }}">X</a></div>                <div class="card-body">
