...
Route::middleware(['auth'])->group(function(){
  ...
  Route::post('calificaciones/store', 'CalificaionesController@store')->name('calificaciones.store')
  ->middleware('permission:gcalificaciones.create');

  Route::get('calificaciones', 'CalificaionesController@index')->name('calificaciones.index')
  ->middleware('permission:calificaciones.index');

  Route::get('calificaciones/create', 'CalificaionesController@create')->name('calificaciones.create')
  ->middleware('permission:gcalificaciones.create');

  Route::put('calificaciones/{calificacion}', 'CalificaionesController@update')->name('calificaciones.update')
  ->middleware('permission:calificaciones.edit');

  Route::get('calificaciones/{calificacion}', 'CalificaionesController@show')->name('calificaciones.show')
  ->middleware('permission:calificaciones.show');

  Route::delete('calificaciones/{calificacion}', 'CalificaionesController@destroy')->name('calificaciones.destroy')
  ->middleware('permission:calificaciones.destroy');

  Route::get('calificaciones/{calificacion}/edit', 'CalificaionesController@edit')->name('calificaciones.edit')
  ->middleware('permission:calificaciones.edit');
