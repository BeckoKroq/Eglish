...
<html lang="es">
    ...
    <body>
      <h1 style="font-size:40px; margin-top: 20px;" ><img style="height:70px; width:70px; margin-top: 30px;" src=<?php echo e(asset ('img/logo.png')); ?> alt="">Control de Inglés</h1>
      <hr>
      <br>
      <div class="datagrid">
        <table>
          ...
          <tbody>
          	<tr>
              <td><p><?php echo e($today); ?></p></td>
          		<td><p><?php echo e($grupo['nombre_grupo']); ?></p></td>
          		<td><p><?php echo e($grupo['periodo']); ?></p></td>
          		<td><p><?php echo e($grupo['nivel']); ?></p></td>
          		<td><p><?php echo e($grupo['docente']); ?></p></td>
          	</tr>
          </tbody>
        </table>
      </div>
